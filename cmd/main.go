...
func init() {
	...
	utilruntime.Must(exampleiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e954b23b.example.io",
	...
	if err = (&controller.MyNginxReconciler{
		ResourceInter: resource.NewResources(mgr.GetClient(), mgr.GetScheme()),
